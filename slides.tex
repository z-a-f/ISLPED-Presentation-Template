...
\usepackage{pgf}                % Image positionining

\usepackage{custom_comms}

% \customtheme[./themes/]{BU}
% \usetheme{Berlin}
\customtheme[./themes/]{ISLPED}
\customcolortheme[./themes/]{ISLPED}

% \usetheme{Copenhagen}

\title[International Symposium on Low Power Electronics and Design 2016]{Technical Standards and Measurement}
\author[Presenter Name]{Author(s) Name}
\institute[Boston University]{\includegraphics[height=1cm]{./logos/boston_univ_red.png}}
\date{\today}

\pgfdeclareimage[height=0.5cm]{bu-logo}{./logos/boston_univ_red.png}
\logo{pgfuseimage{bu-logo}\hspace*{0.3cm}}
